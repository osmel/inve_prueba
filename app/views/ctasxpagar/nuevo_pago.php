...
<?php 
  ...
  $hidden = array('movimiento'=>$movimiento,'tipo_entrada'=>$tipo_entrada,'total'=>$pago->total,'id_factura'=>$pago->id_factura,'id_almacen'=>$pago->id_almacen,'id_empresa'=>$pago->id_empresa );
