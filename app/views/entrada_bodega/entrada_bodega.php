...
echo form_open('validar_proceso_bodega', $attr);
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-6 col-md-4">
				<fieldset class="disabledme">						
					<div class="form-group">
						<label for="id_transferencia_bodega" class="col-sm-12 col-md-12">Tienda-Consecutivo</label>
						<div class="col-sm-12 col-md-12">
							<select name="id_transferencia_bodega" id="id_transferencia_bodega" class="form-control">
									<option value="0" id_almacen="0" id_almacen_destino="0" id_factura_entrada="0">Selecciona una opción</option>
										<?php foreach ( $transferencias as $transf ){ ?>
													<option value="<?php echo $transf->mov_salida_unico; ?>"  id_factura_entrada="<?php echo $transf->id_factura; ?>"  id_almacen="<?php echo $transf->id_almacen; ?>" id_almacen_destino="<?php echo $transf->id_almacen_destino; ?>" ><?php echo $transf->movimiento; ?></option>
										<?php } ?>
								</select>
						</div>
					</div>
	...
	<?php echo form_close(); ?>
					...
					<br>			
						...
						<div class="table-responsive">	
								<section>
									...
									<table id="tabla_transferencia_bodega"	class="display table table-striped table-bordered table-responsive" cellspacing="0" width="100%">
									</table>
			...
			<div class="row">
				...
				<div class="col-sm-4 col-md-3">
					<button id="conf_entrada_bodega"  type="button" class="btn btn-success btn-block">
						Procesar Entrada
					</button>
				</div>
