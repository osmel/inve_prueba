			...
			<table style="width: 100%; border: 2px solid #222222; ">
				...
				<?php if ( isset($movimientos) && !empty($movimientos) ): ?>
					<?php foreach( $movimientos as $movimiento ): ?>
						<tr>
							<td width="8%" style="border-top: 1px solid #222222;"><?php echo $movimiento->conse_nuevo; //movimiento_unico ?></td>					
							...
							<td width="8%" style="border-top: 1px solid #222222;"><?php echo $movimiento->almacen; ?></td>
							<td width="20%" style="border-top: 1px solid #222222;"><?php echo $movimiento->nombre; ?></td>
