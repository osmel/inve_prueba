...
<?php
 	if (!isset($retorno)) {
      	$retorno ="entrada_compra";
    }
 $rest = substr($nombrecompleto, -1); 
    
 $hidden = array('id'=>$id); ?>
<?php echo form_open('validar_eliminar_prod_temporal_compra', array('class' => 'form-horizontal','id'=>'form_eliminar','name'=>$retorno, 'method' => 'POST', 'role' => 'form', 'autocomplete' => 'off' ) ,   $hidden ); ?>
