					...
					<div  class="row">
							...
							<div id="almacen_id" class="col-xs-12 col-sm-6 col-md-2" <?php echo 'style="display:'.( (($config_almacen->activo==0) && ($el_perfil==2) ) ? 'none':'block').'"'; ?>>
								...
								<?php } ?>	
										...
										<select name="id_almacen_costo" id="id_almacen_costo" class="form-control ttip" title="Seleccione el almacén del producto a consultar.">
							...
							<div class="col-xs-12 col-sm-6 col-md-2">
								...
								<label for="id_factura_costo"  class="col-sm-3 col-md-12">Tipo</label>
							...
							<div id="fecha_id">
								...
								<div id="estatus_id" class="col-xs-12 col-sm-6 col-md-2">
									<div class="form-group">
										...
										<div class="col-sm-12 col-md-12">
											<select name="id_estatuss_costo" id="id_estatuss_costo" class="form-control ttip" title="Seleccione el estatus del producto a consultar.">
								...
								<div id="proveedor_id" class="col-xs-12 col-sm-6 col-md-3">
											...
											<div class="form-group">
												...
												<div class="col-sm-12 col-md-12">
													 <input  type="text" name="editar_proveedor_costo" id="editar_proveedor_costo" idproveedor="1" class="form-control buscar_proveedor_costo ttip" title="Campo predictivo. Comience a escribir y seleccione una opción para agregar un filtro de selección." autocomplete="off" spellcheck="false" placeholder="Buscar...">
												</div>
											</div>
								...
								<div id="fecha_id" class="col-xs-12 col-sm-6 col-md-3">
									...
									<div class="input-prepend input-group  form-group" style="padding-left:15px !important;padding-right:15px !important;">
										...
										<input id="foco_costo" type="text" name="permisos"  class="form-control col-sm-12 col-md-12 fecha_costo ttip" title="Seleccione un rango de fechas para filtrar los resultados." value="" format = "DD-MM-YYYY"/> 
									</div>	
			                     </div>
					...
					<div class="col-md-12">	
						...
						<div class="table-responsive">
						   ...
						   <hr style="padding: 0px; margin: 8px;"/>					
							...
							<br>
							<section>
								<table id="tabla_costo_inventario" class="display table table-striped table-bordered table-responsive " cellspacing="0" width="100%">
									<!--
