				...
				<div class="col-sm-12 col-md-6">
					...
					<div class="form-group">
						...
						<div class="col-sm-12 col-md-12">
							...
							?>
							<input value="<?php echo  set_value('minimo_kg',$nomb_nom); ?>" type="text" class="form-control ttip minimo" title="Números y puntos decimales." restriccion="decimal" name="minimo_kg" placeholder="Mínimo kgs">
						</div>
					</div>						
