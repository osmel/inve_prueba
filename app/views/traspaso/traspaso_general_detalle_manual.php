	...
	<div class="container row">					
		<div class="col-md-12">		
						...
						<div class="table-responsive">
							<section>
								<table id="traspaso_general_detalle_manual" class="display table table-striped table-bordered table-responsive " cellspacing="0" width="100%">
								</table>
							</section>
						</div>		
						...
						<div class="col-md-12">	
							<div class="row">
								...
								<div class="col-sm-3 col-md-3">
									...
									<a href="<?php echo base_url(); ?>imprimir_detalle_general_traspaso_manual/<?php echo base64_encode($id_usuario); ?>/<?php echo base64_encode($id_almacen); ?>/<?php echo base64_encode($id_factura); ?>"  
